...
function _startObjBlink(el){_stopObjBlink();_objBlinkEl=el;let t=0;function frame(){t+=0.04;const b=1+0.5*Math.sin(t*2.5);el.style.filter='brightness('+b.toFixed(2)+')';_objBlinkRaf=requestAnimationFrame(frame);}frame();}
